/*
  ...
  - The primary key for the `applicationmagangs` table will be changed. If it partially fails, the table could be left without primary key constraint.
...
*/
-- AlterTable
ALTER TABLE `applicationmagangs` DROP PRIMARY KEY,
